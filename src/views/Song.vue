  ...
  <!-- Music Header -->
    <section class="w-full mb-8 py-14 text-center text-white relative">
      ...
      <div class="container mx-auto flex items-center">
        <!-- Play/Pause Button -->
        <button @click.prevent="newSong(song)" id="play-button"
          type="button"
    ...
    <section class="container mx-auto mt-6" id="comments">
      <div class="bg-white rounded border border-gray-200 relative flex flex-col">
        ...
        <div class="p-6">
          <div :class="comment_alert-variant" v-if="comment_show_alert" class="text-white text-center font-bold p-4 mb-">
          ...
          <vee-form :validation-schema="schema" @submit="addComment" v-if="userLoggedIn">
            ...
            <button :disabled="comment_in_submission"  type="submit" class="py-1.5 px-3 rounded text-white bg-green-600 block">
              Submit
            </button>
          </vee-form>
          <!-- Sort Comments -->
...
export default {
  ...
  methods: {
    ...
    async addComment(values, { resetForm }) {
      ...
      this.comment_alert_variant = 'bg-greed-500';
